"""
server.py - Sonar MCP server.

Exposes a single tool via FastMCP that mirrors the execute_es_query pattern
in ConnectChat. The agent is responsible for constructing a valid iNaturalist
URL; this tool executes it and returns the response.

Run directly only for debugging:
    python src/sonar/server.py
"""
...
if __name__ == "__main__":
    # stdio mode — this is how MultiServerMCPClient launches the server in Phase 1
